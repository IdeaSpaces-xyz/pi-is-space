...
description: >
  ...
  context or prior turns may be relevant. Use after cleanup/compaction when the
...
Recall is the counterpart to cleanup: cleanup keeps active context small; recall deliberately retrieves relevant prior process from the local Pi session tree.
